...
Package module list = import closure of partner/contest_optimizer.py (26 modules, shipped as
op_src.py + helpers) PLUS `tests/synth_instances.py` (op_wrapper's `_warm_jit_kernels`
