...
def test_checkpoint_contract_requires_same_shape_and_frozen_3d3f():
    from icdc.train_topology_prior import (
        checkpoint_contract,
...
def test_source_contract_rejects_c0_that_is_not_source_ema():
    from icdc.train_topology_prior import verify_source_contract
...
def test_load_paired_records_binds_receipt_case_and_sparse_label(tmp_path):
    from icdc.train_topology_prior import load_paired_records
    from icdc.topology_data import fingerprint_case
...
def test_export_corpus_reconstructs_only_authorized_training_inputs(tmp_path):
    from icdc.export_corpus import export_corpus
...
def test_three_trajectory_sparse_loss_backpropagates_through_real_tiny_model():
    ...
    from icdc.topology_data import CorpusSourceReceipt, SparseEdge, TopologyLabel
    from icdc.train_topology_prior import TrainingRecord, _trajectory_loss
    from icdc.topology_data import fingerprint_case
