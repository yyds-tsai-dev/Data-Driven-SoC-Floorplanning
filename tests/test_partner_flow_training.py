...
import flow_matching_train as flow_train
from flow_matching_train import (
    checkpoint_method,
    masked_flow_loss,
    mib_objective,
    parse_flow_extras,
...
def test_mib_aspect_is_d4_invariant_so_golden_reference_survives_augmentation():
    ...
    import direct_diffusion_train as trainer
...
def test_module_import_does_not_mutate_sys_path():
    ...
    sys.modules.pop("flow_matching_train", None)
    try:
        importlib.import_module("flow_matching_train")
