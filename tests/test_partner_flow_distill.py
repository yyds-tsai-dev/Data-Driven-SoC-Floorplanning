...
These lock the parts of ``flow_distill_claude`` that are easy to get silently
...
from flow_distill_claude import (apply_shift, default_max_skip, sample_windows,
...
def test_distilled_tag_is_loadable_by_the_flow_checkpoint_guard():
    ...
    from flow_distill_claude import TRAINING_METHOD
    from flow_train_claude import FLOW_METHODS, checkpoint_method
