...
The implementation is default-off behind `PARTNER_COL_LNS_ORACLE=1`; the
submission path is unchanged unless the experiment flag is set.
...
**NO-GO. Do not implement G1 or ship the oracle hook.**
