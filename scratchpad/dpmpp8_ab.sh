...
export PARTNER_BUDGET_MAX=3.5 PARTNER_DDIM_STEPS=25 PARTNER_DIRECT_MIN=2.0 PARTNER_DIRECT_SOLVER=dpmpp PARTNER_DDIM_STEPS=8

OUT="$ROOT/artifacts/partner_eval/dpmpp8_ab.json"
cd "$ROOT/FloorSet/iccad2026contest"
echo "TREATMENT-DPMPP8 -> $OUT"
