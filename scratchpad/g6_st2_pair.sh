#!/bin/bash
# st2 vs st4 paired probe: does the monotone GPU-time-release trend bottom out?
...
run_arm g6_st4_a PARTNER_DDIM_STEPS=4
run_arm g6_st2_a PARTNER_DDIM_STEPS=2
run_arm g6_st4_b PARTNER_DDIM_STEPS=4
run_arm g6_st2_b PARTNER_DDIM_STEPS=2
