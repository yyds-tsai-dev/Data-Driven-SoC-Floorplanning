...
export PARTNER_BUDGET_MAX=3.5 PARTNER_DDIM_STEPS=25 PARTNER_DIRECT_MIN=1.0 PARTNER_DIRECT_SOLVER=dpmpp PARTNER_DDIM_STEPS=10

OUT="$ROOT/artifacts/partner_eval/dpmpp10_dm10_rep2.json"
