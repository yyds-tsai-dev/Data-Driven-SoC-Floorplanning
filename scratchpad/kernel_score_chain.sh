#!/bin/bash
# SA kernel score conversion: does 2.7x SA moves/s turn into noRT quality
# at the production point (3.5s) and the goal point (0.25s)?
...
run_arm k_ctrl35   PARTNER_BUDGET_MAX=3.5
run_arm k_on35     PARTNER_BUDGET_MAX=3.5 PARTNER_SA_KERNEL=numba
run_arm k_ctrl025  PARTNER_BUDGET_MAX=0.25 PARTNER_BUDGET_MIN=0.15 PARTNER_POOL_GATE=0
run_arm k_on025    PARTNER_BUDGET_MAX=0.25 PARTNER_BUDGET_MIN=0.15 PARTNER_POOL_GATE=0 PARTNER_SA_KERNEL=numba
run_arm k_on10     PARTNER_BUDGET_MAX=1.0 PARTNER_POOL_GATE=0 PARTNER_SA_KERNEL=numba
