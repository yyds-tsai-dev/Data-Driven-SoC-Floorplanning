...
export PARTNER_FLOW_SLOTS=10 PARTNER_FLOW_STEPS=1 PARTNER_FLOW_SOLVER=euler PARTNER_FLOW_ANTITHETIC=1
...
OUT="$ROOT/artifacts/partner_eval/dpmpp10_flowst1.json"
