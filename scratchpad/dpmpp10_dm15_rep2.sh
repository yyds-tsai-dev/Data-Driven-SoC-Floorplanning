...
export PARTNER_BUDGET_MAX=3.5 PARTNER_DDIM_STEPS=25 PARTNER_DIRECT_MIN=1.5 PARTNER_DIRECT_SOLVER=dpmpp PARTNER_DDIM_STEPS=10

OUT="$ROOT/artifacts/partner_eval/dpmpp10_dm15_rep2.json"
