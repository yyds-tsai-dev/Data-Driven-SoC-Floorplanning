#!/bin/bash
# st1 floor probe + flow6 settlement, paired against st2 controls.
...
run_arm g7_st2_a   PARTNER_DDIM_STEPS=2
run_arm g7_st1_a   PARTNER_DDIM_STEPS=1
run_arm g7_flow6_a PARTNER_FLOW_STEPS=6
run_arm g7_st2_b   PARTNER_DDIM_STEPS=2
run_arm g7_st1_b   PARTNER_DDIM_STEPS=1
run_arm g7_flow6_b PARTNER_FLOW_STEPS=6
